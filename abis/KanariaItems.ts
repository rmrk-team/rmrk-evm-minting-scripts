export const KanariaItems = [
  ...
  },
  {
    ...
    name: 'batchAddEquippableAssetEntries',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'parentContract', type: 'address' },
      { internalType: 'uint256', name: 'destinationId', type: 'uint256' },
      { internalType: 'uint64[][]', name: 'assetIds', type: 'uint64[][]' },
    ],
    name: 'batchNestMintWithAssets',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
