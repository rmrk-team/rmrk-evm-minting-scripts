...
export const deploy = async () => {
  ...
  for (const id of Object.keys(KUSAMA_KINGDOM_KUSAMA_DETAILS)) {
    ...
    const hashTransferOwnership = await nftContract.write.transferOwnership([ROYALTY_RECEPIENT]);
    await publicClient.waitForTransactionReceipt({ hash: hashTransferOwnership });
  }
